		...
		<div className={classes.main}>
			...
			<div className={classes.container}>
				<form className={classes.form}>
					<div className={classes.form_header__wrap}>
						<div className={classes.form_header}>
							<NavLink to="/login" className={classes.back}>
								<BackHome className={classes.yGpYhu}/>
							</NavLink>
							<div className={classes.form_header__heading}>ĐẶT LẠI MẬT KHẨU</div>
						</div>
					</div>

					<div className={classes.form_body}>
						<div className={classes.form_input__wrap}>
							<input className={classes.form_input} placeholder="Email/Số Điện Thoại" type="text"></input>
						</div>
						<button className={classes.form_button} disabled>TIẾP THEO</button>
					</div>
				</form>
			</div>
