			...
			<div className={classes.container}>
				<div className={classes.container_content}>
					<form className={classes.form}>
						...
						<div className={classes.form_support}>
                            <NavLink to="/login" className={classes.form_support__link}>Đăng nhập với mật khẩu</NavLink>
                        </div>
...
export default withStyles(styles)(LoginSMS);